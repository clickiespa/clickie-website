(function () {
  ...
  var mobileMenu = ""
    ...
    + "    <a href=\"" + siteUrl("servicios/gestion-retail.html") + "\" class=\"" + mobileItemClass("servicios/gestion-retail.html", "mobile-item--featured-retail") + "\"><i class=\"fa-solid fa-store mobile-sub-icon menu-item-icon\" aria-hidden=\"true\"></i><span>Retail</span></a>"
    ...
    + "    <span class=\"mobile-subheading menu-subheading\">Por Solución</span>"
    ...
    + "    <a href=\"" + siteUrl("recursos/blog.html") + "\" class=\"" + mobileItemClass("recursos/blog.html") + "\"><i class=\"fa-solid fa-pen-nib mobile-sub-icon menu-item-icon\" aria-hidden=\"true\"></i><span>Blog</span></a>"
    +      mobileCaseLink
    ...
    + "    <a href=\"" + siteUrl("nosotros.html") + "\" class=\"" + mobileItemClass("nosotros.html") + "\"><span>Nuestros Valores</span></a>"
    + "    <a href=\"" + siteUrl("nosotros/prensa.html") + "\" class=\"" + mobileItemClass("nosotros/prensa.html") + "\"><span>Clickie en la Prensa</span></a>"
    + "    <a href=\"" + contactoHref + "\" class=\"" + mobileItemClass(null) + "\"><span>Contacto</span></a>"
    + "  </div>"
  ...
  var navbar = ""
    ...
    + "      <a href=\"" + logoHref + "\" class=\"navbar-logo\" aria-label=\"Clickie inicio\"><img src=\"" + siteUrl("assets/logo-clickie-menu.png") + "\" alt=\"Clickie\" class=\"navbar-logo-full\" />"
    + "      </a>"
    ...
    + "          <div class=\"mega-dropdown mega-dropdown--services-full\" id=\"megaDropdownServicios\">"
    + "            <div class=\"mega-dropdown-inner mega-dropdown-layout mega-dropdown-layout--services-full\">"
    + "              <div class=\"mega-dropdown-section\">"
    + "                <span class=\"mega-dropdown-section-title\">POR RUBRO</span>"
    + "                <p class=\"mega-dropdown-section-copy\">Soluciones por industria.</p>"
    + "                <div class=\"mega-dropdown-items\">"
    + "                  <a href=\"" + siteUrl("servicios/gestion-retail.html") + "\" class=\"" + dropdownItemClass("servicios/gestion-retail.html", "mega-item--featured-retail") + "\">"
    + "                    <div class=\"mega-item-icon\"><i class=\"fa-solid fa-store\" aria-hidden=\"true\"></i></div>"
    + "                    <div class=\"mega-item-content\"><strong>Retail</strong><span>Eficiencia energética en tiendas y cadenas comerciales.</span></div>"
    + "                  </a>"
    ...
    + "                    <div class=\"mega-item-content\"><strong>Industria</strong><span>Optimización energética en plantas e instalaciones industriales.</span></div>"
    + "                  </a>"
    + "                </div>"
    + "              </div>"
    + "              <div class=\"mega-dropdown-section\">"
    + "                <span class=\"mega-dropdown-section-title\">POR SOLUCIÓN</span>"
    + "                <p class=\"mega-dropdown-section-copy\">Nuestras plataformas de gestión energética.</p>"
    + "                <div class=\"mega-dropdown-items mega-dropdown-items--2col\">"
    ...
    + "                    <div class=\"mega-item-content\"><strong>UBM</strong><span>Gestión de Suministros Eléctricos.</span></div>"
    + "                  </a>"
    ...
    + "                    <div class=\"mega-item-content\"><strong>EMS</strong><span>Monitoreo, Gestión y Optimización Energética en Tiempo Real.</span></div>"
    + "                  </a>"
    ...
    + "                    <div class=\"mega-item-content\"><strong>BMS</strong><span>Control Inteligente.</span></div>"
    + "                  </a>"
    ...
    + "                    <div class=\"mega-item-content\"><strong>Remarcación y Submetering</strong><span>Distribución interna justa de energía.</span></div>"
    + "                  </a>"
    + "                </div>"
    + "              </div>"
    + "            </div>"
    ...
    + "                  <a href=\"" + siteUrl("historias/oxxo.html") + "\" class=\"" + dropdownItemClass("historias/oxxo.html", "mega-item--story-logo") + "\" aria-label=\"OXXO\"><div class=\"mega-item-logo-wrap\"><img src=\"" + siteUrl("assets/logos/clickie-oxxo.png") + "\" alt=\"OXXO\" class=\"mega-item-logo mega-item-logo--oxxo\" /></div><div class=\"mega-item-content\"><strong>OXXO</strong><span>Ahorro energético en más de 230 tiendas.</span></div></a>"
    + "                  <a href=\"" + siteUrl("historias/starbucks.html") + "\" class=\"" + dropdownItemClass("historias/starbucks.html", "mega-item--story-logo") + "\" aria-label=\"Starbucks\"><div class=\"mega-item-logo-wrap\"><img src=\"" + siteUrl("assets/logos/clickie-starbucks.png") + "\" alt=\"Starbucks\" class=\"mega-item-logo mega-item-logo--starbucks\" /></div><div class=\"mega-item-content\"><strong>Starbucks</strong><span>Monitoreo en tiempo real de sus locales.</span></div></a>"
    + "                  <a href=\"" + siteUrl("historias/copec.html") + "\" class=\"" + dropdownItemClass("historias/copec.html", "mega-item--story-logo") + "\" aria-label=\"COPEC\"><div class=\"mega-item-logo-wrap\"><img src=\"" + siteUrl("assets/logos/clickie-copec.svg") + "\" alt=\"COPEC\" class=\"mega-item-logo mega-item-logo--copec\" /></div><div class=\"mega-item-content\"><strong>COPEC</strong><span>Monitoreo centralizado de energías renovables.</span></div></a>"
    + "                  <a href=\"" + siteUrl("historias/lipigas.html") + "\" class=\"" + dropdownItemClass("historias/lipigas.html", "mega-item--story-logo") + "\" aria-label=\"Lipigas\"><div class=\"mega-item-logo-wrap\"><img src=\"" + siteUrl("assets/logos/clickie-lipigas.png") + "\" alt=\"Lipigas\" class=\"mega-item-logo mega-item-logo--lipigas\" /></div><div class=\"mega-item-content\"><strong>Lipigas</strong><span>Eficiencia energética en sus plantas productivas.</span></div></a>"
    + "                  <a href=\"" + siteUrl("historias/tattersall.html") + "\" class=\"" + dropdownItemClass("historias/tattersall.html", "mega-item--story-logo") + "\" aria-label=\"Tattersall\"><div class=\"mega-item-logo-wrap\"><img src=\"" + siteUrl("assets/logos/clickie-tattersall.png") + "\" alt=\"Tattersall\" class=\"mega-item-logo mega-item-logo--tattersall\" /></div><div class=\"mega-item-content\"><strong>Tattersall</strong><span>Gestión energética de 45 puntos críticos.</span></div></a>"
    + "                  <a href=\"" + siteUrl("historias/preunic.html") + "\" class=\"" + dropdownItemClass("historias/preunic.html", "mega-item--story-logo") + "\" aria-label=\"Preunic\"><div class=\"mega-item-logo-wrap\"><img src=\"" + siteUrl("assets/logos/clickie-preunic.png") + "\" alt=\"Preunic\" class=\"mega-item-logo mega-item-logo--preunic\" /></div><div class=\"mega-item-content\"><strong>Preunic</strong><span>Control automatizado de energía en tiendas.</span></div></a>"
    + "                  <a href=\"" + siteUrl("historias/la-araucana.html") + "\" class=\"" + dropdownItemClass("historias/la-araucana.html", "mega-item--story-logo") + "\" aria-label=\"La Araucana\"><div class=\"mega-item-logo-wrap\"><img src=\"" + siteUrl("assets/logos/clickie-la-araucana.png") + "\" alt=\"La Araucana\" class=\"mega-item-logo mega-item-logo--la-araucana\" /></div><div class=\"mega-item-content\"><strong>La Araucana</strong><span>Menor huella de carbono en sus sucursales.</span></div></a>"
    + "                </div>"
    + "              </div>"
    + "            </div>"
    + "          </div>"
    ...
    + "            <div class=\"mega-dropdown-inner mega-dropdown-layout mega-dropdown-layout--compact-3col\">"
    + "              <div class=\"mega-dropdown-section\">"
    + "                <span class=\"mega-dropdown-section-title\">APRENDER</span>"
    + "                <div class=\"mega-dropdown-items\">"
    + "                  <a href=\"" + siteUrl("recursos/guias.html") + "\" class=\"" + dropdownItemClass("recursos/guias.html") + "\"><div class=\"mega-item-icon\"><i class=\"fa-solid fa-book-open\" aria-hidden=\"true\"></i></div><div class=\"mega-item-content\"><strong>Guías</strong><span>Consejos para ahorrar energía por rubro.</span></div></a>"
    + "                  <a href=\"" + siteUrl("recursos/blog.html") + "\" class=\"" + dropdownItemClass("recursos/blog.html") + "\"><div class=\"mega-item-icon\"><i class=\"fa-solid fa-pen-nib\" aria-hidden=\"true\"></i></div><div class=\"mega-item-content\"><strong>Blog</strong><span>Ideas y novedades sobre gestión energética.</span></div></a>"
    + "                  <a href=\"https://www.youtube.com/@clickie4338\" target=\"_blank\" rel=\"noopener\" class=\"" + dropdownItemClass(null) + "\"><div class=\"mega-item-icon\"><i class=\"fa-solid fa-circle-play\" aria-hidden=\"true\"></i></div><div class=\"mega-item-content\"><strong>YouTube</strong><span>Videos sobre energía y Clickie.</span></div></a>"
    + "                </div>"
    + "              </div>"
    + "              <div class=\"mega-dropdown-section\">"
    + "                <span class=\"mega-dropdown-section-title\">EVALUAR</span>"
    + "                <div class=\"mega-dropdown-items\">"
    + "                  <a href=\"" + siteUrl("recursos/casos-de-negocio.html") + "\" class=\"" + dropdownItemClass("recursos/casos-de-negocio.html") + "\"><div class=\"mega-item-icon\"><i class=\"fa-solid fa-file-invoice-dollar\" aria-hidden=\"true\"></i></div><div class=\"mega-item-content\"><strong>Casos de Negocio</strong><span>Ahorro y retorno de inversión por rubro.</span></div></a>"
    ...
    + "                  <a href=\"" + siteUrl("recursos/encuesta-madurez.html") + "\" class=\"" + dropdownItemClass("recursos/encuesta-madurez.html") + "\"><div class=\"mega-item-icon\"><i class=\"fa-solid fa-list-check\" aria-hidden=\"true\"></i></div><div class=\"mega-item-content\"><strong>Encuesta</strong><span>Evalúa la madurez energética de tu empresa.</span></div></a>"
    + "                </div>"
    + "              </div>"
    + "              <div class=\"mega-dropdown-section mega-dropdown-section--featured\">"
    + "                <span class=\"mega-dropdown-section-title\">Destacado <span class=\"mega-section-badge\">Nuevo</span></span>"
    + "                <a href=\"" + siteUrl("recursos/analisis-ems-2025/") + "\" class=\"mega-featured-card " + (isCurrentPage("recursos/analisis-ems-2025/") ? "is-current" : "") + "\">"
    + "                  <div class=\"mega-featured-card-icon\"><i class=\"fa-solid fa-chart-line\" aria-hidden=\"true\"></i></div>"
    + "                  <strong class=\"mega-featured-card-title\">EMS 2025: De Dashboards a Autonomía</strong>"
    + "                  <span class=\"mega-featured-card-desc\">Lectura Clickie del informe Verdantix · 47 proveedores · LATAM</span>"
    + "                  <span class=\"mega-featured-card-cta\">Leer análisis →</span>"
    + "                </a>"
    + "              </div>"
    + "            </div>"
    + "          </div>"
    ...
    + "              <div class=\"mega-dropdown-section\">"
    + "                <div class=\"mega-dropdown-items\">"
    + "                  <a href=\"" + siteUrl("nosotros.html") + "\" class=\"" + dropdownItemClass("nosotros.html") + "\"><div class=\"mega-item-content\"><strong>Nuestros valores</strong></div></a>"
    + "                  <a href=\"" + siteUrl("nosotros/prensa.html") + "\" class=\"" + dropdownItemClass("nosotros/prensa.html") + "\"><div class=\"mega-item-content\"><strong>Clickie en la prensa</strong></div></a>"
    + "                  <a href=\"" + contactoHref + "\" class=\"" + dropdownItemClass(null) + "\"><div class=\"mega-item-content\"><strong>Contacto</strong></div></a>"
    + "                </div>"
    + "              </div>"
  ...
  var footer = ""
    ...
    + "        <a href=\"" + logoHref + "\" class=\"navbar-logo navbar-logo--light\"><img src=\"" + siteUrl("assets/logo-clickie-web.png") + "\" alt=\"Clickie\" class=\"navbar-logo-full\" />"
    + "        </a>"
    ...
    + "          <a href=\"" + siteUrl("recursos/blog.html") + "\" class=\"social-link\" aria-label=\"Blog\"><i class=\"fa-solid fa-pen-nib\" aria-hidden=\"true\"></i></a>"
    + "        </div>"
    + "      </div>"
    + "      <div class=\"footer-col\">"
    + "        <h4>Servicios</h4>"
    + "        <div class=\"footer-links\">"
    + "          <a href=\"" + siteUrl("servicios/gestion-retail.html") + "\" class=\"footer-link\">Retail</a>"
    + "          <a href=\"" + siteUrl("servicios/eficiencia-energetica.html") + "\" class=\"footer-link\">Industria</a>"
    + "          <a href=\"" + siteUrl("servicios/ubm.html") + "\" class=\"footer-link\">UBM</a>"
    + "          <a href=\"" + siteUrl("servicios/ems.html") + "\" class=\"footer-link\">EMS</a>"
    + "          <a href=\"" + siteUrl("servicios/bms.html") + "\" class=\"footer-link\">BMS</a>"
    ...
    + "          <a href=\"" + siteUrl("historias/preunic.html") + "\" class=\"footer-link\">Preunic — Retail multisucursal</a>"
    + "          <a href=\"" + siteUrl("historias/tattersall.html") + "\" class=\"footer-link\">Tattersall — Eficiencia operativa</a>"
    + "          <a href=\"" + siteUrl("historias/starbucks.html") + "\" class=\"footer-link\">Starbucks — Consumo en tiendas</a>"
    + "        </div>"
    + "      </div>"
    + "      <div class=\"footer-col\">"
    + "        <h4>Acceso rápido</h4>"
